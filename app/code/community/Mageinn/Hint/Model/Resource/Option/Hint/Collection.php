...
/**
 * Option Hint collection model
 *
 * @category   Mageinn
 * @package    Mageinn_Hint
 * @author     Mageinn
 */
class Mageinn_Hint_Model_Resource_Option_Hint_Collection
    extends Mage_Core_Model_Resource_DB_Collection_Abstract
{
    ...
    {
        parent::_construct();
        $this->_init('mageinn_hint/option_hint');
    }
    ...
    public function addCurrentStore()
    {
        ...
        $joinCondition = $this->getConnection()
                ->quoteInto(
                    'main_table.option_id = store.option_id AND store.store_id = ?', 
